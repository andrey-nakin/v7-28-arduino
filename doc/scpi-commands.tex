...
\title{Прошивка эмуляции мультиметра Hewlett-Packard 34401A. \\ Список поддерживаемых команд}
...
В данном документе приведён список SCPI команд, реализованных в прошивке-эмуляторе мультиметра Hewlett-Packard \mbox{34401A} на базе микроконтроллера Arduino \mbox{Mega2560} и цифрового вольтметра \mbox{В7-28}.
...
Из-за отсутствия технической возможности тестирование не производится.
